...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-surface">
      {/* PAGE HEADER — Poll info + poll-level control */}
      <header className="border-b bg-card shadow-sm">
        <div className="mx-auto max-w-6xl px-6 py-5">
          <button
            onClick={() => setBackDialogOpen(true)}
            className="mb-3 inline-flex items-center gap-2 rounded-md p-1.5 text-sm text-muted-foreground hover:bg-muted hover:text-foreground"
          ...
          <div className="mt-5 flex flex-wrap items-center justify-between gap-4 border-t pt-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button
                onClick={() => window.open(`/polls/${pollId}/join`, "_blank", "noopener")}
                variant="outline"
                className="h-10 rounded-lg border-info bg-transparent px-3 text-info hover:bg-info/10 hover:text-info"
              >
        ...
        <Tabs defaultValue={defaultTab} className="w-full">
          <TabsList className="h-auto w-full justify-start gap-6 rounded-none border-b bg-transparent p-0">
            ...
            >
              RESULTS
              {liveQuestion && (
                <span className="ml-2 inline-flex h-1.5 w-1.5 animate-pulse rounded-full bg-primary" />
              )}
            </TabsTrigger>
            <TabsTrigger
              value="qa"
            ...
            <section className="rounded-2xl bg-card p-6 shadow-sm">
              {liveQuestion ? (
                <div>
                  ...
                  <div className="flex h-72 items-center justify-center rounded-lg bg-surface text-sm text-muted-foreground">
          ...
          <TabsContent value="qa" className="mt-6">
            <section className="rounded-2xl bg-card p-10 text-center text-muted-foreground shadow-sm">
              {liveQA
                ...
                : "Enable Live Q&A in the header to start collecting questions."}
            </section>
          </TabsContent>
        </Tabs>
      </main>
